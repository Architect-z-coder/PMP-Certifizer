...
import { C, KA, FOCUS, STARTERS, T, JT, CR, LENS, lightColor, BE_AREAS, PEOPLE_AREAS } from "./pmp.js";
...
export default function App() {
  ...
  const isKA = KA.some((k) => k.id === focusId) || BE_AREAS.includes(focusId) || PEOPLE_AREAS.includes(focusId);
