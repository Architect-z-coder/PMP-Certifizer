...
- 🔴 **Dérogation ECO-EXC-01 (décision Zoubir, 15/07/2026)** : déploiement SANS vérification humaine du référentiel. Risque résiduel accepté : une erreur de transcription machine non détectée. Atténuation : sentinelles étendues aux **26 intitulés officiels complets** (`test_eco_canonical.py`). Levée de la dérogation : renseigner réviseur + date + SHA-256 du PDF dans `docs/rapport-verification-referentiel.md`.
